				...
				<div class="container">
					<div class="row">
						<div class="col_xxs_12 col_xs_12 col_s_12 col_m_8 col_l_8">
							<div class="module_title"><a href="g_page_1.php">Гарантийка</a> <i class="fal fa-arrow-right"></i> %договор% <i class="fal fa-arrow-right"></i> Все КС</div>
						</div>
								...
								<div class="item clr_b2">
									<div class="title">
										<label class="radiocheck">
											...
											<strong>КС № <?php echo $id; ?></strong>
										</label>
										
										<div class="more docs animate_150">
											<a href="javascript:;">От 6 декабря 2018 г.</a>
											<a href="javascript:;" class="toggle_cb" data-toggle="details_<?php echo $id; ?>">Показать что-то</a>
										</div>
										...
										<div class="details details_<?php echo $id; ?> hide_me">
											<span>Сумма по КС — 0 000 000 руб.</span>
											
											<span>Сумма гарантийного платежа — 0 000 000 руб.</span>
											
											<span>
												Срок погашения гарантийного платежа — 15 декабря 2018 г. (осталось 4 дня)
											</span>
										</div>
									</div>
								</div>
