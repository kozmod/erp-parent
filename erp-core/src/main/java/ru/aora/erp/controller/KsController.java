...
public class KsController {
    ...
    public KsController(KsServiceImpl ksService) { this.ksService = ksService; }

        @GetMapping
        public String getKs(@RequestParam("id_parent") String id_parent, @RequestParam("id_grand_parent") String id_grand_parent, @RequestParam("parent_name") String contract_name, @RequestParam("grand_parent_name") String counteragent_name, Map<String, Object> model, Principal principal) {
    ...
    @PutMapping
    public @ResponseBody String putKs(@RequestBody Ks ks) {
    ...
    @PostMapping
    public @ResponseBody String postKs(@RequestBody Ks ks) {
        if(ks!=null) { ksService.create(ks);
